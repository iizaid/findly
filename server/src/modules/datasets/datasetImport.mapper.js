...
const aliases = {
  businessName: [
    ...
    'instagram name', 'page name', 'company', 'place name',
  ],
  instagramUrl: ['instagram', 'instagram url', 'profile url', 'instagram link', 'ig url', 'source url'],
  instagramUsername: ['username', 'handle', 'instagram handle', 'ig handle', 'account', 'instagram username'],
  ...
  address: ['address', 'full address', 'formatted address', 'maps address'],
  ...
  googleMapsUrl: ['google maps url', 'google maps search url', 'maps url', 'google maps', 'map url', 'place url'],
  facebookUrl: ['facebook', 'facebook url', 'facebook link'],
  rating: ['rating', 'google rating', 'stars'],
  reviewCount: ['reviews', 'review count', 'google reviews', 'reviews count'],
