...
const buildConfigurationSummary = () => {
  ...
  const categories = {
    ...
    security: {
      sessionSecure: env.COOKIE_SECURE ?? env.NODE_ENV === 'production',
      csrfSecure: env.CSRF_COOKIE_SECURE ?? env.NODE_ENV === 'production',
      sessionSameSite: env.COOKIE_SAME_SITE,
      csrfSameSite: env.CSRF_COOKIE_SAME_SITE,
