  ...
  <div className="rounded-2xl border border-accent/40 bg-accent/10 p-5">
    <div className="flex items-start gap-3">
      ...
      <div>
        ...
        {resultSummary.presenceTargetsRequested?.length ? ` while prioritizing ${resultSummary.presenceTargetsRequested.map((platform) => PLATFORM_LABELS[platform] || platform).join(', ')}` : ''}
        {' '}and saved the result set in Lead Lists.
        </p>
      </div>
    </div>
